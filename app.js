...
const weeks = [
  { num:1, phase:'base', label:'Return To Running', km:36,
    days:{ Mon:{type:'Easy Run',detail:'8km easy at 5:35–6:00/km',dot:'easy',km:8,target_pace:'5:35–6:00/km'}, Tue:{type:'Strength',detail:'45 min gym · RDL, split squat, hip thrust, hamstring curl, calves, core',dot:'strength'}, Wed:{type:'Intervals',detail:'6 × 3 min @ 4:20–4:25/km · 2 min easy jog recovery · 2km WU/CD · total ~9km',dot:'hard',km:9,target_pace:'4:20–4:25/km',intervals:{reps:6,dist:3.0,targetPace:'4:20'}}, Thu:{type:'Rest',detail:'Full rest',dot:'rest'}, Fri:{type:'Easy + Strides',detail:'7km easy + 6 × 20 sec relaxed strides · walk-back recovery',dot:'easy',km:7,target_pace:'5:35–6:00/km'}, Sat:{type:'Long Run',detail:'12km easy at 5:35–6:05/km',dot:'easy',km:12,target_pace:'5:35–6:05/km'}, Sun:{type:'Rest',detail:'Full rest',dot:'rest'} }},
  { num:2, phase:'base', label:'Building Consistency', km:39,
    days:{ Mon:{type:'Easy Run',detail:'8km easy at 5:35–6:00/km',dot:'easy',km:8,target_pace:'5:35–6:00/km'}, Tue:{type:'Strength',detail:'45 min gym · RDL, split squat, hip thrust, hamstring curl, calves, core',dot:'strength'}, Wed:{type:'Intervals',detail:'5 × 1km @ 4:12–4:15/km · 2 min easy jog recovery · 2km WU/CD · total ~10km',dot:'hard',km:10,target_pace:'4:12–4:15/km',intervals:{reps:5,dist:1.0,targetPace:'4:12'}}, Thu:{type:'Rest',detail:'Full rest',dot:'rest'}, Fri:{type:'Tempo',detail:'8km total including 20 min tempo @ 4:25–4:30/km',dot:'moderate',km:8,target_pace:'4:25–4:30/km',tempo:{duration_min:20,targetPace:'4:25'}}, Sat:{type:'Long Run',detail:'13km easy at 5:35–6:05/km',dot:'easy',km:13,target_pace:'5:35–6:05/km'}, Sun:{type:'Rest',detail:'Full rest',dot:'rest'} }},
  { num:3, phase:'base', label:'Volume Build', km:42,
    days:{ Mon:{type:'Easy Run',detail:'9km easy at 5:35–6:00/km',dot:'easy',km:9,target_pace:'5:35–6:00/km'}, Tue:{type:'Strength',detail:'45 min gym · RDL, split squat, hip thrust, hamstring curl, calves, core',dot:'strength'}, Wed:{type:'Intervals',detail:'3 × 2km @ 4:15–4:18/km · 3 min easy jog recovery · 2km WU/CD · total ~11km',dot:'hard',km:11,target_pace:'4:15–4:18/km',intervals:{reps:3,dist:2.0,targetPace:'4:15'}}, Thu:{type:'Rest',detail:'Full rest',dot:'rest'}, Fri:{type:'Easy + Strides',detail:'8km easy + 6 × 20 sec relaxed strides · walk-back recovery',dot:'easy',km:8,target_pace:'5:35–6:00/km'}, Sat:{type:'Long Run',detail:'14km easy at 5:35–6:05/km',dot:'easy',km:14,target_pace:'5:35–6:05/km'}, Sun:{type:'Rest',detail:'Full rest',dot:'rest'} }},
  { num:4, phase:'base', label:'Deload', km:34,
    days:{ Mon:{type:'Easy Run',detail:'7km easy at 5:35–6:05/km',dot:'easy',km:7,target_pace:'5:35–6:05/km'}, Tue:{type:'Strength',detail:'35–40 min lighter gym session · reduce load and avoid soreness',dot:'strength'}, Wed:{type:'Intervals',detail:'6 × 800m @ 4:10–4:15/km · 2 min standing/walk recovery · 2km WU/CD · total ~9km',dot:'hard',km:9,target_pace:'4:10–4:15/km',intervals:{reps:6,dist:800.0,targetPace:'4:10'}}, Thu:{type:'Rest',detail:'Full rest',dot:'rest'}, Fri:{type:'Easy Run',detail:'7km easy at 5:35–6:05/km',dot:'easy',km:7,target_pace:'5:35–6:05/km'}, Sat:{type:'Long Run',detail:'11km easy at 5:35–6:05/km',dot:'easy',km:11,target_pace:'5:35–6:05/km'}, Sun:{type:'Rest',detail:'Full rest',dot:'rest'} }},
  { num:5, phase:'build', label:'Specific Build Starts', km:43,
    days:{ Mon:{type:'Easy Run',detail:'9km easy at 5:35–6:00/km',dot:'easy',km:9,target_pace:'5:35–6:00/km'}, Tue:{type:'Strength',detail:'45 min gym · moderate load · RDL, split squat, hip thrust, hamstring curl, calves, core',dot:'strength'}, Wed:{type:'Intervals',detail:'4 × 1.5km @ 4:12–4:15/km · 2:30 easy jog recovery · 2km WU/CD · total ~11km',dot:'hard',km:11,target_pace:'4:12–4:15/km',intervals:{reps:4,dist:1.5,targetPace:'4:12'}}, Thu:{type:'Rest',detail:'Full rest',dot:'rest'}, Fri:{type:'Threshold',detail:'9km total including 2 × 12 min @ 4:22–4:27/km · 3 min easy jog recovery',dot:'moderate',km:9,target_pace:'4:22–4:27/km',tempo:{duration_min:12,targetPace:'4:22'}}, Sat:{type:'Long Run',detail:'14km easy at 5:35–6:05/km',dot:'easy',km:14,target_pace:'5:35–6:05/km'}, Sun:{type:'Rest',detail:'Full rest',dot:'rest'} }},
  { num:6, phase:'build', label:'Volume Lift', km:46,
    days:{ Mon:{type:'Easy Run',detail:'10km easy at 5:35–6:00/km',dot:'easy',km:10,target_pace:'5:35–6:00/km'}, Tue:{type:'Strength',detail:'45 min gym · moderate load · avoid grinding reps',dot:'strength'}, Wed:{type:'Intervals',detail:'5 × 1km @ 4:08–4:12/km · 2 min easy jog recovery · 2km WU/CD · total ~10km',dot:'hard',km:10,target_pace:'4:08–4:12/km',intervals:{reps:5,dist:1.0,targetPace:'4:08'}}, Thu:{type:'Rest',detail:'Full rest',dot:'rest'}, Fri:{type:'Tempo',detail:'10km total including 25 min continuous tempo @ 4:23–4:28/km',dot:'moderate',km:10,target_pace:'4:23–4:28/km',tempo:{duration_min:25,targetPace:'4:23'}}, Sat:{type:'Long Run',detail:'16km easy at 5:35–6:05/km',dot:'easy',km:16,target_pace:'5:35–6:05/km'}, Sun:{type:'Rest',detail:'Full rest',dot:'rest'} }},
  { num:7, phase:'build', label:'Aerobic Push', km:48,
    days:{ Mon:{type:'Easy Run',detail:'10km easy at 5:35–6:00/km',dot:'easy',km:10,target_pace:'5:35–6:00/km'}, Tue:{type:'Strength',detail:'40–45 min gym · maintain load, no soreness chasing',dot:'strength'}, Wed:{type:'Intervals',detail:'3 × 2km @ 4:10–4:13/km · 3 min easy jog recovery · 2km WU/CD · total ~12km',dot:'hard',km:12,target_pace:'4:10–4:13/km',intervals:{reps:3,dist:2.0,targetPace:'4:10'}}, Thu:{type:'Rest',detail:'Full rest',dot:'rest'}, Fri:{type:'Easy + Strides',detail:'9km easy + 6 × 20 sec relaxed strides · walk-back recovery',dot:'easy',km:9,target_pace:'5:35–6:00/km'}, Sat:{type:'Long Run',detail:'17km easy · optional last 3km steady at 4:55–5:10/km if feeling good',dot:'easy',km:17,target_pace:'5:35–6:05/km'}, Sun:{type:'Rest',detail:'Full rest',dot:'rest'} }},
  { num:8, phase:'build', label:'Deload', km:39,
    days:{ Mon:{type:'Easy Run',detail:'8km easy at 5:35–6:05/km',dot:'easy',km:8,target_pace:'5:35–6:05/km'}, Tue:{type:'Strength',detail:'35–40 min lighter gym session · reduce eccentric load',dot:'strength'}, Wed:{type:'Intervals',detail:'8 × 400m @ 3:58–4:05/km · 90 sec standing/walk recovery · 2km WU/CD · total ~8km',dot:'hard',km:8,target_pace:'3:58–4:05/km',intervals:{reps:8,dist:400.0,targetPace:'3:58'}}, Thu:{type:'Rest',detail:'Full rest',dot:'rest'}, Fri:{type:'Threshold',detail:'9km total including 18 min @ 4:22–4:27/km',dot:'moderate',km:9,target_pace:'4:22–4:27/km',tempo:{duration_min:18,targetPace:'4:22'}}, Sat:{type:'Long Run',detail:'14km easy at 5:35–6:05/km',dot:'easy',km:14,target_pace:'5:35–6:05/km'}, Sun:{type:'Rest',detail:'Full rest',dot:'rest'} }},
  { num:9, phase:'build', label:'Peak Volume', km:50,
    days:{ Mon:{type:'Easy Run',detail:'10km easy at 5:35–6:00/km',dot:'easy',km:10,target_pace:'5:35–6:00/km'}, Tue:{type:'Strength',detail:'35–40 min gym · reduced volume, maintain movement quality',dot:'strength'}, Wed:{type:'Intervals',detail:'4 × 2km @ 4:10–4:12/km · 3 min easy jog recovery · 2km WU/CD · total ~13km',dot:'hard',km:13,target_pace:'4:10–4:12/km',intervals:{reps:4,dist:2.0,targetPace:'4:10'}}, Thu:{type:'Rest',detail:'Full rest',dot:'rest'}, Fri:{type:'Threshold',detail:'10km total including 30 min @ 4:20–4:25/km',dot:'moderate',km:10,target_pace:'4:20–4:25/km',tempo:{duration_min:30,targetPace:'4:20'}}, Sat:{type:'Long Run',detail:'17km easy at 5:35–6:05/km',dot:'easy',km:17,target_pace:'5:35–6:05/km'}, Sun:{type:'Rest',detail:'Full rest',dot:'rest'} }},
  { num:10, phase:'peak', label:'Race-Specific Sharpening', km:46,
    days:{ Mon:{type:'Easy Run',detail:'9km easy at 5:35–6:00/km',dot:'easy',km:9,target_pace:'5:35–6:00/km'}, Tue:{type:'Strength',detail:'30–35 min light/moderate gym · no heavy eccentric soreness',dot:'strength'}, Wed:{type:'Intervals',detail:'3 × 3km @ 4:12–4:15/km · 3 min easy jog recovery · 2km WU/CD · total ~13km',dot:'hard',km:13,target_pace:'4:12–4:15/km',intervals:{reps:3,dist:3.0,targetPace:'4:12'}}, Thu:{type:'Rest',detail:'Full rest',dot:'rest'}, Fri:{type:'Easy + Strides',detail:'8km easy + 6 × 20 sec relaxed strides · walk-back recovery',dot:'easy',km:8,target_pace:'5:35–6:00/km'}, Sat:{type:'Long Run',detail:'16km easy at 5:35–6:05/km',dot:'easy',km:16,target_pace:'5:35–6:05/km'}, Sun:{type:'Rest',detail:'Full rest',dot:'rest'} }},
  { num:11, phase:'peak', label:'Race Simulation', km:35,
    days:{ Mon:{type:'Easy Run',detail:'8km easy at 5:35–6:00/km',dot:'easy',km:8,target_pace:'5:35–6:00/km'}, Tue:{type:'Strength',detail:'Light activation only · 25–30 min · no soreness',dot:'strength'}, Wed:{type:'Intervals',detail:'10 × 400m @ 3:58–4:05/km · 75–90 sec standing/walk recovery · 2km WU/CD · total ~8km',dot:'hard',km:8,target_pace:'3:58–4:05/km',intervals:{reps:10,dist:400.0,targetPace:'3:58'}}, Thu:{type:'Rest',detail:'Full rest',dot:'rest'}, Fri:{type:'Easy Run',detail:'7km easy at 5:35–6:05/km',dot:'easy',km:7,target_pace:'5:35–6:05/km'}, Sat:{type:'Race Simulation',detail:'2km WU · 6–8km @ 4:10–4:15/km · 2km CD · total ~12km',dot:'race',km:12,target_pace:'4:10–4:15/km'}, Sun:{type:'Rest',detail:'Full rest',dot:'rest'} }},
  { num:12, phase:'taper', label:'Freshen Up', km:33,
    days:{ Mon:{type:'Easy Run',detail:'7km easy at 5:35–6:05/km',dot:'easy',km:7,target_pace:'5:35–6:05/km'}, Tue:{type:'Strength',detail:'Short activation only · 20–25 min · no heavy lifting',dot:'strength'}, Wed:{type:'Intervals',detail:'5 × 1km @ 4:10–4:12/km · 2:30 easy jog recovery · 2km WU/CD · total ~9km',dot:'hard',km:9,target_pace:'4:10–4:12/km',intervals:{reps:5,dist:1.0,targetPace:'4:10'}}, Thu:{type:'Rest',detail:'Full rest',dot:'rest'}, Fri:{type:'Easy + Strides',detail:'7km easy + 4 × 20 sec relaxed strides · walk-back recovery',dot:'easy',km:7,target_pace:'5:35–6:05/km'}, Sat:{type:'Long Run',detail:'10km easy at 5:35–6:05/km',dot:'easy',km:10,target_pace:'5:35–6:05/km'}, Sun:{type:'Rest',detail:'Full rest',dot:'rest'} }},
  { num:13, phase:'taper', label:'Race Week', km:26,
    days:{ Mon:{type:'Easy Run',detail:'6km easy at 5:35–6:05/km',dot:'easy',km:6,target_pace:'5:35–6:05/km'}, Tue:{type:'Rest',detail:'Full rest',dot:'rest'}, Wed:{type:'Sharpening',detail:'4km easy + 4 × 20 sec relaxed strides · walk-back recovery',dot:'easy',km:4,target_pace:'easy + relaxed strides'}, Thu:{type:'Rest',detail:'Full rest',dot:'rest'}, Fri:{type:'Rest',detail:'Full rest',dot:'rest'}, Sat:{type:'Shakeout',detail:'3km very easy + 4 × 15 sec strides · full walk-back recovery',dot:'easy',km:3,target_pace:'very easy'}, Sun:{type:'RACE DAY',detail:'Shelley Loop 10km · Target sub-42 · 2km warm-up + drills + 4 short strides',dot:'race',km:13,target_pace:'4:11/km race target'} }},
];
...
// ── Splits visual bars ──
  ...
  // Verdict badge is computed AFTER we know whether a debrief exists — see below.
  // (placeholder kept here so verdictConfig stays in scope)

  // ── Coach insight: ONLY derived from a confirmed debrief. Never from raw
  // Strava laps/splits for hard sessions — those include warmups, recoveries,
  // and cooldowns and produce meaningless numbers.
  const isHardSession = act.session_type_detected === 'intervals' || act.session_type_detected === 'tempo';
  const hasDebrief = !!debrief;
  const repSegs = Array.isArray(debrief?.segments) ? debrief.segments.filter(s => s.type === 'rep' && s.pace) : [];
  ...
  if (isHardSession) {
    // Hard sessions: insight exists ONLY once the user has entered structured reps.
    if (repSegs.length >= 1) {
      const repSecsArr = repSegs.map(s => {
        const [m,sc] = s.pace.split(':').map(Number);
        return m*60+(sc||0);
      });
      const effortSecs = Math.round(repSecsArr.reduce((a,b)=>a+b,0) / repSecsArr.length);
      const targetSecs = act.target_pace_secs || (() => {
        const tp = match?.planned?.intervals?.targetPace || match?.planned?.tempo?.targetPace;
        if (!tp) return null;
        const [m,sc] = tp.split(':').map(Number);
        return m*60+(sc||0);
      })();
      const diff = targetSecs ? targetSecs - effortSecs : null;
      const ePaceStr = `${Math.floor(effortSecs/60)}:${String(effortSecs%60).padStart(2,'0')}`;
      const tPaceStr = targetSecs ? `${Math.floor(targetSecs/60)}:${String(targetSecs%60).padStart(2,'0')}` : null;

      if (diff != null) {
        const vKey = diff > 8 ? 'faster' : diff < -8 ? 'slower' : 'on_target';
        const vc = verdictConfig[vKey];
        verdictBadge = `<div style="display:inline-flex;align-items:center;gap:6px;padding:4px 10px;border-radius:20px;background:${vc.bg};color:${vc.col};border:1px solid ${vc.border};font-size:12px;font-weight:600;font-family:var(--mono);margin-bottom:8px">${vc.label}</div>`;
      }

      paceCompareHTML = `<div style="display:flex;gap:16px;flex-wrap:wrap;margin-bottom:10px;font-size:12px">
        <div style="display:flex;flex-direction:column;gap:2px">
          ...
          <span style="font-family:var(--mono);font-size:18px;font-weight:600;color:${diff > 0 ? '#14532D' : diff < 0 ? '#92600A' : 'var(--text)'}">${ePaceStr}/km</span>
        </div>
        ${tPaceStr ? `<div style="display:flex;align-items:center;padding-top:14px;color:var(--text-faint)">vs</div>
        <div style="display:flex;flex-direction:column;gap:2px">
          ...
          <span style="font-family:var(--mono);font-size:18px;font-weight:400;color:var(--text-muted)">${tPaceStr}/km</span>
        </div>` : ''}
      ...
      if (repSegs.length >= 2) {
        const rows = repSegs.map((s, i) => {
          const [m,sc] = s.pace.split(':').map(Number);
          const secs = m*60+(sc||0);
          const rDiff = targetSecs ? targetSecs - secs : null;
          const col = rDiff == null ? 'var(--text-muted)' : rDiff > 5 ? '#14532D' : rDiff < -5 ? '#92600A' : '#1E40AF';
          const diffStr = rDiff != null ? (rDiff > 0 ? `+${rDiff}s` : `${rDiff}s`) : '';
          return `<tr>
            <td style="font-family:var(--mono);font-size:12px;color:var(--text-faint);padding:4px 8px 4px 0">${s.label || 'Rep ' + (i+1)}</td>
            <td style="font-family:var(--mono);font-size:13px;font-weight:600;color:${col};padding:4px 8px 4px 0">${s.pace}/km</td>
            <td style="font-family:var(--mono);font-size:11px;color:${col};padding:4px 0">${diffStr}</td>
          </tr>`;
        }).join('');
        repTableHTML = `<div style="margin-bottom:12px"><table style="border-collapse:collapse">${rows}</table></div>`;
      }

      const margin = diff != null ? Math.abs(diff) : null;
      if (margin != null) {
        coachNote = diff > 8
          ? `You held ${margin}s/km faster than target across your reps. Strong session — consider nudging target pace up next time.`
          : diff < -8
          ? `You were ${margin}s/km slower than target. Could be fatigue or a tough day — keep the same target and reassess.`
          : `Reps held right on target pace. Good execution.`;
      }
    } else {
      enterRepsPrompt = `<div style="font-size:12px;color:var(--text-faint);font-style:italic;padding:4px 0">Add session details below to log your rep paces — coach insight will appear once you do.</div>`;
    }
  } else {
    // Easy / long run sessions: average pace from Strava IS meaningful.
    if (act.effort_pace_secs && act.target_pace_secs) {
      const ePaceStr = `${Math.floor(act.effort_pace_secs/60)}:${String(Math.round(act.effort_pace_secs%60)).padStart(2,'0')}`;
      const tPaceStr = `${Math.floor(act.target_pace_secs/60)}:${String(Math.round(act.target_pace_secs%60)).padStart(2,'0')}`;
      const diff = act.pace_diff_secs;
      const vKey = act.pace_verdict === 'faster' ? 'faster' : act.pace_verdict === 'slower' ? 'slower' : 'on_target';
      const vc = verdictConfig[vKey];
      verdictBadge = vc ? `<div style="display:inline-flex;align-items:center;gap:6px;padding:4px 10px;border-radius:20px;background:${vc.bg};color:${vc.col};border:1px solid ${vc.border};font-size:12px;font-weight:600;font-family:var(--mono);margin-bottom:8px">${vc.label}</div>` : '';
      paceCompareHTML = `<div style="display:flex;gap:16px;flex-wrap:wrap;margin-bottom:10px;font-size:12px">
        <div style="display:flex;flex-direction:column;gap:2px">
          <span style="font-family:var(--mono);color:var(--text-faint);font-size:10px;text-transform:uppercase;letter-spacing:0.06em">Pace</span>
          <span style="font-family:var(--mono);font-size:18px;font-weight:600;color:var(--text)">${ePaceStr}/km</span>
        </div>
...
return `<div class="activity-card" id="acard-${actId}">
  ...
  <div class="debrief-editor" id="debrief-editor-${actId}" style="display:none">
    ...
    ${(() => {
      ...
      const isIntervalsT = act.session_type_detected === 'intervals';
      if (!isTempo && !isIntervalsT) return '';
      ...
      const slots = Array.from({ length: repCount }, (_, i) => savedSegs[i] || { pace: '', distance_km: '' });
      const repTargetPace = planned?.intervals?.targetPace || planned?.tempo?.targetPace || '4:12';
      const repDistKm = isTempo ? null : (planned?.intervals?.dist >= 1 ? planned.intervals.dist : (planned?.intervals?.dist || 1) / 1000);

      const stepLabel = isTempo
        ? `Tempo block <span style="font-weight:400;color:var(--text-muted)">— enter the time and pace you held. Warm-up/cool-down inferred from total distance.</span>`
        : `Rep paces <span style="font-weight:400;color:var(--text-muted)">— ${plannedReps} × ${repDistKm}km planned @ ${repTargetPace}/km target. Warm-up/cool-down inferred automatically.</span>`;

      return `
    <div style="font-size:10px;font-family:var(--mono);color:var(--accent);font-weight:600;letter-spacing:0.06em;margin-bottom:8px">STEP 1 — WORKOUT STRUCTURE</div>
    <div style="margin-bottom:4px;font-size:12px;font-weight:600;color:var(--text)">${stepLabel}</div>
    <div id="rep-inputs-${actId}">
      ${isTempo ? `
        <div style="display:flex;align-items:center;gap:8px;margin-bottom:6px;flex-wrap:wrap">
          <span style="font-size:11px;color:var(--text-faint);width:80px">Duration</span>
          <input class="debrief-input" style="width:70px" placeholder="${planned?.tempo?.duration_min || 20}" value="${slots[0]?.duration_min || planned?.tempo?.duration_min || ''}" id="tempo-duration-${actId}" />
          <span style="font-size:11px;color:var(--text-faint)">min</span>
          <span style="font-size:11px;color:var(--text-faint);width:50px;margin-left:8px">Pace</span>
          <input class="debrief-input" style="width:90px;font-family:var(--mono)" placeholder="${repTargetPace}" value="${slots[0]?.pace || ''}" id="rep-pace-${actId}-0" />
          <span style="font-size:11px;color:var(--text-faint)">/km</span>
        </div>
      ` : slots.map((seg, i) =>
        `<div style="display:flex;align-items:center;gap:8px;margin-bottom:6px">
          <span style="font-size:11px;color:var(--text-faint);font-family:var(--mono);width:50px">Rep ${i+1}</span>
          <input class="debrief-input" style="width:90px;font-family:var(--mono)" placeholder="${repTargetPace}" value="${seg.pace || ''}" id="rep-pace-${actId}-${i}" />
          <span style="font-size:11px;color:var(--text-faint)">/km</span>
        </div>`
      ).join('')}
    </div>
    ${!isTempo ? `<button class="btn-secondary" style="font-size:11px;padding:3px 8px;margin-bottom:4px" onclick="addRepInput('${actId}','${repTargetPace}')">+ Add rep</button>` : ''}
    <div style="font-size:11px;color:var(--text-faint);font-style:italic;margin:4px 0 16px">Warm-up and cool-down distance/pace will be calculated from the total activity distance — no need to enter them.</div>
    <div style="border-top:1px solid var(--border);margin-bottom:14px"></div>
    `;
    })()}

    <div style="font-size:10px;font-family:var(--mono);color:var(--accent);font-weight:600;letter-spacing:0.06em;margin-bottom:8px">STEP 2 — SESSION DETAILS</div>

    <textarea
      class="debrief-textarea"
      id="debrief-text-${actId}"
      rows="3"
      placeholder="Anything else worth noting — how it felt, conditions, etc. Optional."
...
async function submitDebriefEditor(actId) {
  ...
  const tempoDurationInput = document.getElementById(`tempo-duration-${actId}`);
  const tempoDurationMin = tempoDurationInput ? Number(tempoDurationInput.value) || null : null;
  ...
  if (repContainer) {
    ...
    repInputs.forEach((input, i) => {
      ...
      if (val && /^\d+:\d{2}$/.test(val)) {
        const seg = { type: 'rep', label: isTempoSession ? 'Tempo pace' : `Rep ${i+1}`, pace: val };
        if (isTempoSession && tempoDurationMin) seg.duration_min = tempoDurationMin;
        repSegments.push(seg);
      }
    });
  }

  // Infer warm-up / cool-down distance + pace from total activity distance
  // minus the work segment, using the actual planned session for rep distance.
  let wuCdSegment = null;
  if (repSegments.length >= 1 && act.distance) {
    const plannedSession = matchActivityToSession(act)?.planned;
    let workKm = 0;
    if (isTempoSession && tempoDurationMin) {
      const [m, s] = repSegments[0].pace.split(':').map(Number);
      const paceSecsPerKm = m * 60 + (s || 0);
      workKm = (tempoDurationMin * 60) / paceSecsPerKm;
    } else if (!isTempoSession && plannedSession?.intervals?.dist) {
      const repDistKm = plannedSession.intervals.dist >= 1 ? plannedSession.intervals.dist : plannedSession.intervals.dist / 1000;
      workKm = repDistKm * repSegments.length;
    }
    const remainder = workKm > 0 ? Math.max(0, act.distance - workKm) : null;
    if (remainder != null && remainder > 0.3) {
      const wuCdKm = Number(remainder.toFixed(2));
      wuCdSegment = { type: 'warmup_cooldown', label: 'Warm-up / Cool-down (inferred)', distance_km: wuCdKm, pace: act.pace || null };
    }
  }

  const allSegments = wuCdSegment ? [...repSegments, wuCdSegment] : repSegments;

  const repsSummary = repSegments.length
    ? (isTempoSession
        ? `Tempo: ${tempoDurationMin ? tempoDurationMin + 'min @ ' : ''}${repSegments[0].pace}/km`
        : `Reps: ${repSegments.map((s,i) => `Rep ${i+1} ${s.pace}/km`).join(', ')}`)
    : '';
  const wuCdSummary = wuCdSegment ? `Warm-up/cool-down: ~${wuCdSegment.distance_km}km (inferred)` : '';
  ...
  try {
    ...
    const debriefPayload = {
      ...
      segments: allSegments.length ? allSegments : (existing?.segments || []),
